...
void Barrel_Create(EntityBarrel* barrel, double top_left_x, double top_left_y, double w, double h, GraphicResource idle_sprite, GraphicResource explode_sprite) {
	barrel->vtable = {
		Barrel_Place,
		Barrel_Remove,
		Barrel_Think
	...
	AABB_Create(&barrel->sight_aabb, top_left_x, WINDOW_HEIGHT, w, WINDOW_HEIGHT - (top_left_y - h));			// FIXME
...
void Barrel_LightFuse(EntityBarrel* barrel) {
